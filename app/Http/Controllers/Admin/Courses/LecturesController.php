...
class LecturesController extends Controller
{
    ...
    public function index()
    {
        ...
        if($user->hasRole('admin')){
            $data = Lecture::whereNotNull('course_id')->orderBy('created_at','DESC')->paginate(30);
        }else{
            $data = Lecture::whereNotNull('course_id')->where('school_id',$user->school_id)->orderBy('created_at','DESC')->paginate(30);
        }
